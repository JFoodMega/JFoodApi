...
-- Online status for moderators (set true on login, false on logout)
ALTER TABLE moderators ADD COLUMN IF NOT EXISTS is_online BOOLEAN NOT NULL DEFAULT false;
